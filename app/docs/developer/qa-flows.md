...
2. Fill in a name and submit (`POST /onboarding/workspaces`).
   **Expect:** The workspace is created, `onboarded_at` is stamped immediately, and you are redirected to the workspace (`workspace_path`).
